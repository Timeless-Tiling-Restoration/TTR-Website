                ...
                <div class="flex flex-wrap lg:items-center -m-8">
                    <div class="w-full md:w-1/2 p-8">
                        <div class="md:max-w-md">
                            ...
                            <h2 class="font-heading mb-6 text-4xl md:text-5xl text-gray-100 font-black tracking-tight">All-in-one, next-gen SaaS experience</h2>
                            <p class="mb-5 text-gray-500 font-bold">Yearly access to all products with ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</p>
                                ...
                                <div class="flex flex-wrap -m-3">
                                    <div class="w-full p-3">
                                        <div class="flex flex-wrap -m-4">
                                            ...
                                            <div class="flex-1 p-4">
                                                <h3 class="font-heading mb-3 text-2xl text-gray-100 font-bold">Connect</h3>
                                                <p class="text-gray-500 font-bold">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="w-full p-3">
                                        <div class="flex flex-wrap -m-4">
                                            ...
                                            <div class="flex-1 p-4">
                                                <h3 class="font-heading mb-3 text-2xl text-gray-100 font-bold">Store</h3>
                                                <p class="text-gray-500 font-bold">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="w-full p-3">
                                        <div class="flex flex-wrap -m-4">
                                            ...
                                            <div class="flex-1 p-4">
                                                <h3 class="font-heading mb-3 text-2xl text-gray-100 font-bold">Ship</h3>
                                                <p class="text-gray-500 font-bold">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                            </div>
                                        </div>
                                    </div>
