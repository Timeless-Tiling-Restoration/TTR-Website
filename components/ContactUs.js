...
const infoData = {
    ...
    contact: {
        title: 'Contact',
        lines: ['stef1999@gmail.com', '+61 411 669 974'],
    },
    socials: [
        {
            href: '#',
        ...
        <section className="py-20 bg-secondary">
            <div className="container px-4 mx-auto">
                ...
                <div className="flex flex-wrap -mx-4">
                    ...
                    <div className="w-full lg:w-1/3 px-4 mb-4 lg:mb-0">
                        <div className="py-12 h-full border text-center rounded-xl">
                            <h3 className="mb-6 text-2xl font-semibold font-heading">{contact.title}</h3>
