          ...
          <div className="flex w-full flex-col">
            <div className="hero bg-base-100 min-h-screen">
              <div className="hero-content flex-col lg:flex-row">
                ...
                <div>
                  <h1 className="text-5xl font-bold">How we quote</h1>
                  <p className="py-6 text-error">
                    Give little brief description here
                  </p>
                  <button className="btn btn-primary">Ready to get started?</button>
                </div>

                <ul className="timeline timeline-vertical">
                  <li>
                    <div className="text-2xl timeline-start timeline-box">1. Quotation</div>
                    <hr />
                  </li>
                  <li>
                    <hr />
                    <div className="text-2xl timeline-end timeline-box">2. Book a On-Site Evaluation</div>
                    <hr />
                  </li>
                  <li>
                    <hr />
                    <div className="text-2xl timeline-start timeline-box">3. Let's Restore it!</div>
                    <hr />
                  </li>
                </ul>
              </div>
